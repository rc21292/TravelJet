...
<link href="{{asset('frontend/css/bootstrap.min.css')}}" rel="stylesheet">
	...
	<link rel="stylesheet" href="{{asset('frontend/css/selectize.bootstrap3.min.css')}}" integrity="sha256-ze/OEYGcFbPRmvCnrSeKbRTtjG4vGLHXgOqsyLFTRjg=" crossorigin="anonymous" />
	<link rel="stylesheet" type="text/css" href="{{asset('frontend/css/agent/stylesheet.css')}}">
