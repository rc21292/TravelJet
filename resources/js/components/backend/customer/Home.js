...
function Home() {
	...
	return (
		...
		<p>
		<Link className="btn btn-pill btn-gradient-info" to={'/customer/wallet'}>Deposit Fund</Link>
		</p>
		</div>
		</div>
		</div>
		...
		<span>Kai Clarke Send A Proposel For Project Mechanical Works</span>
		<div style={{ marginLeft : '50px' }}><b>2 hours ago</b>
		</div>
		</td>
		</tr>
		<tr>
		...
		<hr/>
		<center>
		<p><button type="button" className="btn btn-pill btn-gradient-info">View All</button></p>
		</center>
		</div>
		</div>
		</div>
