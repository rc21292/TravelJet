                ...
                <div>
                  <div className="viewquotation" style={{display: 'block'}}>
                    ...
                    <div className="wt-userlistinghold wt-featured">
                      ...
                      <div className="bookid"> <span>Booking id : 000000{ id}</span>
                      ...
                      <div className="wt-userlistingcontent">
                        <div className="wt-contenthead">
                          <div className="wt-title"> <a href="#"> Lorem Ipsum 
                    ...
                    <div id="exTab1">
                      <ul className="nav nav-pills">
                      {
                        quotationData.map((quotation,i)=>{
                          return (
                        <li  key={i} className="active"> <a href={"#"+i+"1a"} data-toggle="tab"><i className="fa fa-inr" /> {quotation.payment}/-
                          <br />
