...
export default class Add extends Component {
	...
	render() {
		return (
			...
			<li id="in_mile" className="list-group-item d-flex justify-content-between align-items-center" /> <br />
			<br />
			<li id="in_kilo" className="list-group-item d-flex justify-content-between align-items-center" /> <br />
			<br />
			<li id="duration_text" className="list-group-item d-flex justify-content-between align-items-center" /> <br />
			<br />
			</ul>
			</div>
			</div>
