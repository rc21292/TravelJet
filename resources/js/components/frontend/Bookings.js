                                ...
                                <div className="row">
                                  <div className="col-sm-6">
                                    ...
                                    <div className="book-locationPanel">
                                      <div className="selectAddress">
                                        <input type="text" value={quotationDetails.pickup_location} placeholder="Pandav Nagar" className="form-control" disabled />
                                      </div>
                                    </div>
                                  ...
                                  <div className="col-sm-6" style={(quotationDetails.type_of_booking == "Round Trip with Sightseeing") ? {display:"none"} : {display:"block"} }>
                                    ...
                                    <div className="book-destinationPanel">
                                      <div className="selectAddress">
                                        <input type="text" value={quotationDetails.drop_location} placeholder="Manali Bus Stand" className="form-control" disabled />
                                      </div>
                                    </div>
