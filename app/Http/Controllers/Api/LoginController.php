...
class LoginController extends Controller
{
  ...
  public function verify(Request $request) 
  {
    ...
    if($request->otp == $otp && $request->phone == $phone){
      ...
      if($phone_check){
        ...
        $user = Auth::user();
          ...
          return response()->json(["message" => "error","id" => '']);
...

      {
        ...
        $this->registerphone($request);
        return response()->json(["message" => "Otp Verified Succesfully"]);
      }  
    ...
    {   
      ...
      return response()->json(["message" => "Phone Number Registered"]);
    } 
